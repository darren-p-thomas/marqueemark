...
ELECTROCOIN_DEFAULT = {"base": "electrocoin-alt-9-fixed.png",
    "base_source": "builtin",
    "layout_id": "electrocoin",
    "cards": [{"source": "fixed", "art": ""}, {"source": "fixed", "art": ""},
              {"source": "fixed", "art": ""}, {"source": "neosd", "art": ""}],
    "windows": [[356, 32, 116, 198], [530, 32, 120, 198],
                [714, 32, 121, 198], [893, 32, 120, 198]]}
BUILTIN_LAYOUTS = {
    "electrocoin": {"id": "electrocoin", "name": "Electrocoin 4 Slot", "base": "electrocoin-alt-9-fixed.png",
